...
/**
 * Note: this is a component that I pulled from an old project of mine, it is from 2018, hence a bit old fashioned. 
 */
...
export class ClickablePanel extends React.Component {
  ...
  componentDidMount() {
    ...
    let me = this;
    const { mouseOverBackgroundColor, callback } = me.props;
    this.setCallbackAndMouseover(callback, mouseOverBackgroundColor);
  }
  ...
  setCallbackAndMouseover(callback, mouseOverBackgroundColor) {
    const me = this; 
    ...
    if (callback && mouseOverBackgroundColor) {
